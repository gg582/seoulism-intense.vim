...
def draw_seoulism_blueprint():
    ...
    # Mapping traditional elements to functional programming roles
    mapping = [
        ...
        {"id": "c4", "tag": "BLUE",   "hex": "#2C5AE0", "element": "METAL",  "logic": "Structure / Type"},
    ...
    # Footer: Systemic Slogan
    ax.text(10, 8, "Follow the colors, then you will find the structure.", 
            color='#2AA394', fontsize=12, ha='left', weight='bold')

    plt.tight_layout()
    plt.savefig('seoulism_blueprint.png', facecolor=bg_base, dpi=300)
    plt.show()
